...
const TodoForm = () => {
  ...
  if (!isShow) {
    return (
      <div className="">
        <button
          className="bg-rose-200 py-2 px-1 rounded-md text-white w-full md:w-1/2"
  ...
  return (
    <form className="bg-white max-w-md rounded-md shadow-md py-4">
      ...
      <div className="px-8 md:flex items-center gap-x-4">
        <button
          className="border border-rose-200 py-2 rounded-md text-rose-200 w-full mb-3"
